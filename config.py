...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7396038693:AAFYFm7TiuRdvzG4ImG9jJTPDEVLr90ZCV0")

APP_ID = int(os.environ.get("APP_ID", "1562317304"))
...
#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>ʜᴇʟʟᴏ {first}\n\n ɪ ᴀᴍ ғɪʟᴇ sᴛᴏʀᴇ ʙᴏᴛ , ɪ ᴄᴀɴ sᴛᴏʀᴇ ᴘʀɪᴠᴀᴛᴇ ғɪʟᴇs ɪɴ sᴘᴇᴄɪғɪᴇᴅ ᴄʜᴀɴɴᴇʟ ᴀɴᴅ ᴏᴛʜᴇʀ ᴜsᴇʀs ᴄᴀɴ ᴀᴄᴄᴇss ɪᴛ ғʀᴏᴍ sᴘᴇᴄɪᴀʟ ʟɪɴᴋ » @TamilLinksOfficial</b>")
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1994781564").split()):
        ADMINS.append(int(x))
except ValueError:
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>»⭕️ Main Channel : @TamilLinksOfficial ⭕️</b>")
